    ...
    <section id="about">
      ...
      <div className="about-contents-1">
        ...
        <p>
          ...
          Biscuits n Groovy, our mission is simple: create a better platform for
        ...
        <p>
          ...
          their headphones, who show up first to a concert to get the best spot.
          We offer these loyal listeners the uniquely intimate experience of
          being the first to hear new music.
        </p>
        <p>
      ...
      <div className="about-contents-2">
        <p>
          ...
          More specifically, with our founders’ carefully-curated collection of
          vinyl records. While we love the convenience and variety of digital
        ...
        <p>
          ...
          everything about listening to a vinyl record is intentional. It gives
          you a chance to sit back and really hear the artist’s story, like
          reading a good book from beginning to end. Physical music provides a
          much needed reprieve from the shuffle-and-go mentality that underpins
          streaming services, and for that matter permeates so much of our
          hectic lives.​ We built our collection to appreciate and support our
          favorite artists in a more meaningful way, and we believe other true
          fans want to do the same.
        </p>
        <p>
          So we started thinking, how can we take modern-day streaming, and
          infuse it with some of the intentionality of vinyl collecting? And in
          doing so, we can help artists recapture some of the autonomy and
        ...
        <p>
          ...
          collection, the original inspiration. Just like the process of making
          and selecting records, everything we do at BnG is thoughtful,
