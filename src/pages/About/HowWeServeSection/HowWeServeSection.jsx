...
//reducer imports
import { howWeServeAboutReducer } from "../../../common/utils/reducers/reducers";
  ...
  return (
    <div className="artist-fans-serve-main-wrapper ">
      <div className="artists-fans-serve-container">
        ...
        {hwsState.showFansInfo && <FansInformationHWS />}
        {hwsState.showArtistsInfo && <ArtistInformationHWS />}
      </div>
    </div>
  );
};
