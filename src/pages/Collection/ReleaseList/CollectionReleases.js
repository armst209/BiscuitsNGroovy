...
const CollectionReleases = () => {
    ...
    const { isLoading, data: releaseData, isError, error, isFetching } = useQuery("collection-library-releases", fetchLibraryCollection, { staleTime: 2000, refetchOnWindowFocus: true, refetchOnReconnect: true, refetchOnMount: false });
    ...
    return (
        releaseData && <CollectionReleaseList releaseData={releaseData?.data.library} />
    );
};
