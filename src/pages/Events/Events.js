                ...
                <div className="single-event-info">
                  <div className="single-event-description">
                    <p>
                      ...
                      young EDM DJs in the game, at 1001 Oakland Ave in the
                      heart of Ann Arbor on November 6, 2021 for an exclusive
                      tailgate concert. The show will begin promptly 3 hours
                      prior to kickoff. Space is limited so fans will be let in
                      on a first come first served bases. However, you may
                      reserve your spot by grabbing a VIP ticket for just $10 on
                      bngroovy.com and presenting it at the door.
                    </p>
                    <p>
                      VIP access tickets ensure you get a spot at the show and
                      get you exclusive perks including:
                    </p>
                    <ul>
                      ...
                      <li>
                        A free copy of “Green Eyes” when it drops on November
                        12th
                      </li>
                      <li className="indented-li">
                        Each BnG release includes exclusive streaming access and
                        a collectible album cover. Read more{" "}
                        <Link to="/faq">here</Link>.
                      </li>
                    </ul>
                    <p>
                      Once you get your ticket, Tweet at us using the hashtag
                      <strong> #BnGpresentsZEVY</strong> for a chance to win
                      some exclusive merch and be featured on our socials!
                    </p>
                  </div>
