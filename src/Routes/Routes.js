...
const ROUTES = [
  {
    ...
    routes: [
      ...
      },
      {
        ...
        exact: true,
        component: (props) => <Subscriber {...props} />,
      },
      {
        path: "/music-purchase-terms",
        key: "MUSIC_PURCHASE_TERMS_PAGE",
        exact: true,
        component: (props) => <PurchaseOfMusic {...props} />,
      },
      {
        path: "/nft-terms",
        key: "NFT_TERMS_PAGE",
        exact: true,
        component: (props) => <NFTTerms {...props} />,
      },
    ],
  },
];
