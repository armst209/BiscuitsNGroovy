...
const NewsLetterForm = ({ status, message, onValidated }) => {
  ...
  useEffect(() => {
    ...
    if (status === "success") {
      ...
      setSuccessMessage(<div className="form-success">Success! Thank you for subscribing!</div>);
      setEmailInputLoginClass("");
      setErrorMessage("");
      ...
      setErrorMessage(<div className="form-error">{`${email} is already subscribed!`}</div>);
      setSuccessMessage("");
  ...
  return (
    <form id="newsletter-form" onSubmit={(e) => handleSubmit(e)}>
      ...
      <fieldset className="input-styles">
        <label className="label-error-message email-label" htmlFor="newsletter-email">
          {emailErrorMessage}
        </label>
        <input
          id="newsletter-email"
        ...
        <button className="newsletter-form-button-container _button" type="submit">
