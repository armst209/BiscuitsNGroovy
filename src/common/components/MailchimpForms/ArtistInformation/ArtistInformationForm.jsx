    ...
    if (status === "success") {
      ...
      setSuccessMessage(
        <div className="form-success">
          Success! Someone from our team will be reaching out to you shortly! Thank you!
        </div>,
      );
      setEmailInputLoginClass("");
      setErrorMessage("");
  ...
  return (
    <form onSubmit={(e) => handleSubmit(e)}>
      ...
      <fieldset className="input-styles">
        <label className="label-error-message artist-email-label" htmlFor="artist-email">
          {emailErrorMessage}
        </label>
        <input
        ...
        <label className="label-error-message artist-name-label" htmlFor="artist-name">
          Artist Name
        </label>
        <input
          id="artist-name"
        ...
        <input
          ...
          name="MERGE5"
        />
        <label className="label-error-message artist-message-label" htmlFor="artist-message">
          Enter a message:
        </label>
        <textarea
          id="artist-message"
